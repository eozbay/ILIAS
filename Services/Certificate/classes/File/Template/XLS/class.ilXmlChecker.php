...
class ilXMLChecker extends ilSaxParser
{
    ...
    */
    public function handlerBeginTag($a_xml_parser, $a_name, $a_attribs) // #fürCarsten es gibt ungenutzte Parameter
    {
        $this->elements++;
    ...
    */
    public function handlerCharacterData($a_xml_parser, $a_data) // #fürCarsten Es gibt einen unbenutzten Parameter
    {
        $this->texts++;
    ...
    /***
     * #Review
     * Es gibt viele unbenutzte Funktionen:
     * getFullError, getXMLSize, getXMLAttributes, getXMLTextSections, getXMLTextSize
     */
